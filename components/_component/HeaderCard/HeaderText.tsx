...
const HeaderText = () => {
  return (
    <div className='flex flex-col gap-4 items-start '>
        ...
        <div>
            <span className=' text-[15px]  lg:text-[15px] md:max-h-[300px]  '  >At Locals Connect, we are dedicated to transforming how communities interact with businesses.<br/> Our platform serves as a dynamic hub where local members, expatriates,
