...
//                 setBusinessData(data.data); // Set the business data

//                 // Initialize selectedImage with the first profile URL or a default image
//                 setSelectedImage(data.data.profileUrl?.[0] || '/default-image.png');

//                 // Initialize formData with business data
//                 setFormData({
//                     businessName: data.data.name || '',
//                     businessEmail: data.data.email || '',
//                     businessPhone: data.data.phone || '',
//                     businessAddress: data.data.address || '',
//                     businessBio: data.data.description || '',
//                     businessServices: data.data.services || [], 
//                     businessCategory: data.data.category || '',
//                 });
//             } catch (error) {
...
//                                         >
//                                             <span>{service.name}</span> {/* Render the service name */}
//                                             <button
//                                                 type="button"
