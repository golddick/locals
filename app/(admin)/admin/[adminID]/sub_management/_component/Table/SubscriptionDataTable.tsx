  ...
  return (
    <div className="bg-[#FFFFFF] rounded-2xl p-4 flex flex-col gap-4">
         <div className="flex items-center py-4 justify-between">
            <h1 className=" font-semibold text-[15px] lg:text-[18px] text-[#282828] flex items-center gap-2">All Users <p>{data.length}</p></h1>
        ...
        <Input
          ...
          onChange={(event) =>
            table.getColumn("tier")?.setFilterValue(event.target.value)
          }
