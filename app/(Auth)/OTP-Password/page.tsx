...
import { OTPFormPasswordInput } from './_component/OTP-pasoword-form'
         ...
         <div>
                <div className='w-full h-[calc(100vh-80px)] p-3 hidden-scrollbar overflow-scroll'>
                     ...
                     <div className='h-[90%] w-full md:w-[80%] lg:w-[80%] mt-20 m-auto flex flex-col gap-4  hidden-scrollbar overflow-scroll '>
                        <FormHeader HeaderText='Enter OTP' PText='Enter Enter OTP from email to be able to reset password' icon='/emojiHand.png'/>
                       
                        <OTPFormPasswordInput/>
