...
import LoginForm from '../SetPassword/Form/ResetForm'
import ResetForm from '../SetPassword/Form/ResetForm'
import { SendPasswordOTP } from './_component/SendOTP-password'
         ...
         <div>
                <div className='w-full h-[calc(100vh-80px)] p-3 hidden-scrollbar overflow-scroll'>
                     ...
                     <div className='h-[90%] w-full md:w-[80%] lg:w-[80%] mt-20 m-auto flex flex-col gap-4  hidden-scrollbar overflow-scroll '>
                        <FormHeader HeaderText='Reset password' PText='Enter email to send OTP to email to be able to reset password' icon='/emojiHand.png'/>
